// api/puma.js — fetch-only, streams image/* bytes
...
const QUERIES = [
  ...
  "puma concolor portrait",
  "puma walking in nature photo",
  "cougar face macro photo",
  "mountain lion in forest photo",
  "wild puma photography outdoors"
];

const FALLBACKS = [
  "https://upload.wikimedia.org/wikipedia/commons/0/0c/Puma_concolor_coryi.jpg",
  "https://upload.wikimedia.org/wikipedia/commons/d/d2/Cougar_in_Yellowstone_National_Park.jpg",
  "https://upload.wikimedia.org/wikipedia/commons/4/4e/Cougar_(Puma_concolor).jpg",
  "https://upload.wikimedia.org/wikipedia/commons/3/3c/Puma_concolor_-_Puma.jpg"
];
...
export default async function handler(req,res){
  ...
  if(!serpKey){
    ...
    res.setHeader("Content-Disposition", `inline; filename="puma.${data.ext}"`);
  ...
  try{
    ...
    return res.status(404).json({ ok:false, error:"no_usable_puma_found" });
  }
}
